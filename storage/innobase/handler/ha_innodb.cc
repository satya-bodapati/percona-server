...
static MYSQL_SYSVAR_UINT(limit_leaf_optimistic_insert_debug,
                         btr_cur_limit_leaf_optimistic_insert_debug,
                         PLUGIN_VAR_RQCMDARG,
                         "Artificially limit the number of records per B-tree "
                         "leaf page (0=unlimited).",
                         nullptr, nullptr, 0, 0, UINT32_MAX, 0);
