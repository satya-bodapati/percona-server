...
enum monitor_id_t {
  ...
  /* Vector index (SPANN) counters */
  MONITOR_MODULE_VEC,
  MONITOR_VEC_SPANN_SEARCHES,
  MONITOR_VEC_SPANN_PROBES,
  MONITOR_VEC_SPANN_POSTING_APPENDS,
  MONITOR_VEC_SPANN_DEAD_APPENDS,
  MONITOR_VEC_SPANN_SPLITS,
  MONITOR_VEC_SPANN_RESAMPLES,
  MONITOR_VEC_SPANN_MERGES,
  MONITOR_VEC_SPANN_GCS,
  MONITOR_VEC_SPANN_REASSIGNS,
