...
/* Percona fix: the cpuid/xgetbv restructure above made the x86 intrinsics
header AVX-conditional, but USE_SSE alone (default x86-64, no -mavx) also
needs __m128/_mm_* declarations. Include it for the SSE-only case too. */
